...
import { ClienteExpediente } from '../models/expedienteClinico.models';
...
export class ExpedienteClinicoComponent implements OnInit {
  ...
  private readonly apiExpediente = `${environment.apiUrl}/api/clientes/expediente`;
  private readonly apiActualizar = `${environment.apiUrl}/api/clientes/actualizar`;
